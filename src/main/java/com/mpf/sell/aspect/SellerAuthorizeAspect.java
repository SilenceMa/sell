...
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.mpf.sell.controller.Sell*.*(..))" +
            "&& !execution(public * com.mpf.sell.controller.SellUserController.*(..))"
    )
    public void verify() {
